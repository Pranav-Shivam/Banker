                ...
                <div class="rounded d-flex justify-content-center">
                    <div class="col-md-4 col-sm-12 shadow-lg p-5 bg-light">
                        <div class="text-center">
                            <h3 class="text-primary">User Can View Details Here</h3>
                        </div>
                        <div class="p-4">
                        ...
                        if(mysqli_num_rows($run_query)>0)
                            {
                                ...
                                <span class="input-group-text bg-primary"><i
                                    ...
                                    <label type="text" name="gender" class="form-control" readonly placeholder="">Gender :- <?= $cust['gender'];?></label>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <label type="number" name="phno" class="form-control" readonly placeholder="Phone Number :- <?= $cust['phNo'];?>" >Phone Number :- <?= $cust['phNo'];?></label>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text bg-primary"><i
                                            class="bi bi-building text-white"></i></span>
                                            <label class="form-control" name="address" rows="3" readonly placeholder=""> Your Address :- <?= $cust['address'];?></label>
                                </div>
                                <!-- <div class="input-group mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <label type="text" name="pin" class="form-control" readonly placeholder="" > Your Security Pin :- <?= $cust['pin'];?><label>
                                </div>
                                <?php }} ?>
